...
parser.add_argument('-log_root', type=str, action='store', default='logs')
parser.add_argument('-log_interval', type=int, action='store', default=20)
...
# limit of lengths
parser.add_argument('-max_num_sections', type=int, action='store', default=4, help='Maximum section length')
...
parser.add_argument('-max_section_len', type=int, action='store', default=500, help='Truncate sections')
...
config.train_file_path = data_basedir + "train.txt"
config.val_file_path = data_basedir + "val.txt"
config.test_file_path = data_basedir + "test.txt"
config.vocab_file_path = data_basedir.replace("/try_out", "") + "vocab"
